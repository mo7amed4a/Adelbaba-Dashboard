        ...
        {subscriptionPlans.map((plan, index) => (
          ...
          >
            <CardHeader className="text-center py-4 rounded-t-xl ">
              ...
              <p className="text-primary my-2 text-lg font-semibold">
                {plan.price}
              </p>
            </CardHeader>
            ...
            <CardFooter className="text-center flex justify-center items-center py-4 rounded-b-xl bg-gray-50">
              <Dialog>
                <DialogTrigger>
                  <button className="px-5 py-2 text-black border border-primary rounded-lg hover:bg-primary hover:text-white transition duration-300">
                    Edit Plan
                  </button>
                </DialogTrigger>
                <DialogContent>
